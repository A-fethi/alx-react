...
### [0. Basic components](./task_0/dashboard/)

### [1. Write the tests for each component](./task_1/)

### [2. Split the Notifications component](./task_2/dashboard/src/Notifications/)

### [3. Checking the application using the React extension](./task_3/)

### [4. Props types & Default props & Shapes](./task_4/dashboard/src/)

### [5. Shapes, Loops, and Keys](./task_5/dashboard/src/)